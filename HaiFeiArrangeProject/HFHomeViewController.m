...
//    [self eualPamrsDetail];
//    [self factoryArrayDetail];
}
...
- (void)installSubViews
{
    ...
    UIButton *constStaticExternButton = [UIButton buttonWithType:UIButtonTypeCustom];
    constStaticExternButton.frame = CGRectMake(10, 160, 150, 40);
    constStaticExternButton.backgroundColor = [UIColor blueColor];
    [constStaticExternButton setTitle:@"const,Static,Extern" forState:UIControlStateNormal];
    constStaticExternButton.titleLabel.font = [UIFont systemFontOfSize:14];
    [constStaticExternButton addTarget:self action:@selector(constStaticExternButtonAction) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:constStaticExternButton];
  
    
    UIButton *blockButton = [UIButton buttonWithType:UIButtonTypeCustom];
    blockButton.frame = CGRectMake(10, 250, 150, 40);
    blockButton.backgroundColor = [UIColor blueColor];
    [blockButton setTitle:@"blockButton" forState:UIControlStateNormal];
    blockButton.titleLabel.font = [UIFont systemFontOfSize:14];
